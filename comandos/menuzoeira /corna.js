/**
 * Comando: corna 🤘💃 (Versão com Foto e Porcentagem)
 * Pasta: diversao
 * Créditos: Benny ⚔️
 */
...
module.exports = {
    name: 'corna',
    category: 'diversao',
    description: 'Mede a porcentagem de corna de um usuário.',
    alias: ['testecorna', 'chifres'],
    async execute(sock, msg, args, { from, sender, mentions, reply }) {
        ...
        try {
            ...
            // CONFIGURAÇÃO: Salve sua foto como 'corna.jpg' em ./media/
            const caminhoFoto = "./media/corna.jpg";
            const porcentagem = Math.floor(Math.random() * 101);

            await sock.sendMessage(from, { react: { text: '💃', key: msg.key }});

            let texto = `*┏━━〔 💃 TESTE DE CORNA 💃 〕━━┛*\n\n`;
            texto += `🎯 @${quemTestou} verificou se @${alvoNome} é corna!\n`;
            texto += `📊 *RESULTADO:* ${porcentagem}% Corna!\n\n`;
            ...
            console.log("Erro no comando corna:", e);
        }
    }
};
